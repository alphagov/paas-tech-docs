...
2. Set up an SSH tunnel to your target Elasticsearch:
    ...
    Elasticsearch instances are only accessible from GOV.UK PaaS. This sets up a tunnel so that you can get access, similar to how we use [Conduit](https://github.com/alphagov/paas-cf-conduit) elsewhere.
