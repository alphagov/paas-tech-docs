...
1. [Create a PostgreSQL backing service (if required)](/deploying_services.html#set-up-a-postgresql-service) and [bind it to your app](/deploying_services.html#bind-a-postgresql-service-to-your-app).
