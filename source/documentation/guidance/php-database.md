...
You can find more information about how to configure the PHP buildpack at the [PHP buildpack configuration documentation](https://docs.cloudfoundry.org/buildpacks/php/gsg-php-config.html).
